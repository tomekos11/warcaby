...
class ImageProcess:
    ...
    def imageSplit(self):        
        ...
        board.showActualImage(self.edgesImage, 'edgesImage')
        ...
        #board.showActualImage(self.trimmed, 'edgesImageAfter')
...
class Board:
    ...
    def getOnlyBoard(self, image):        
        ...
        if adjusted_image is not None:
            ...
            # Wyświetlenie wynikowego wyciętego fragmentu                       
            self.showActualImage(board, 'Po wycieciu:')
    ...
    def ImproveOrientation(self, image):
        ...
        if contours:
            ...
            if angle < 10: 
                ...
                #self.showActualImage(image, '123', False)
                #self.showActualImage(adjusted_image, '1234')
